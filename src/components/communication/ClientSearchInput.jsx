...
const ClientSearchInput = ({ 
  ...
  const clearSelection = () => {
    setSelectedClient({ id: '', name: '', email: '' });
    setSearchTerm('');
    
    if (onClientSelect) {
      onClientSelect({ id: '', name: '', email: '' });
    }
  };
    ...
    <div className={`relative ${className}`}>
      {!selectedClient || !selectedClient.id ? (
        ...
        <div className="border rounded-md p-3 relative">
          ...
          {showVehicles && selectedClient.vehicles && selectedClient.vehicles.length > 0 && (
      ...
      <AnimatePresence>
        {showResults && (
          <motion.div 
            className="absolute z-20 mt-1 w-full bg-card border rounded-md shadow-lg overflow-hidden"
              ...
              <div className="max-h-60 overflow-y-auto divide-y">
                {results.map(client => (
                  ...
                  >
                    ...
                    {showVehicles && client.vehicles && client.vehicles.length > 0 && (
